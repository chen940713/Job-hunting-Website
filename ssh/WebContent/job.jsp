				...
				<div class="st-frame">
					...
					<div style="height:500px;">
						<div class="contact" style="float:left;width:40%;margin-top: 0px;margin-left: 0px">
            					...
            					<li>
 			       					<a href="${ pageContext.request.contextPath }/jobinfo_deleteByAdmin.action?jobinfo_id=<s:property value="#session.findJobinfo.jobinfo_id"/>" onclick="javascript:if(confirm('确定删除？')==false) return false">删除</a>
            					</li>
        					</ul>
						</div>
